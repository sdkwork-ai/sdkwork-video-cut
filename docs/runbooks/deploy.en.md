# Runbook — sdkwork-video-cut deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-video-cut-standalone:0.1.8`
...
install syncs the bundle to `/opt/deploy/sdkwork-video-cut/bundle`, loads the image, starts
...
bin/docker-deploy.sh rollback --environment staging --to 0.1.8       # explicit version
```
