...
Module `sdkwork-video-cut` · runtime code `video_cut` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `video-cut-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `video-cut-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `video-cut-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `video-cut-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `video-cut.sdkwork.com` | 443 ssl + 80 |
