...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `video-cut-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `video-cut-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `video-cut-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `video-cut.sdkwork.com` | 443 ssl + 80 |
